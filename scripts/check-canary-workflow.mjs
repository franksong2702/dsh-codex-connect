...
for (const [name, change] of [
  ...
  ['missing Think/Remember lifecycle', reports => { delete reports[1].runtime.thinkRememberLifecycle }],
  ['in-process-only Think/Remember lifecycle', reports => { reports[1].runtime.thinkRememberLifecycle.freshProcesses = 0 }],
  ['missing Think/Remember fallback', reports => { reports[1].runtime.thinkRememberLifecycle.modes.pop() }],
