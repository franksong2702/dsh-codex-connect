...
assertContract('an exact declared version is unchanged', classifyCandidateVersion('0.1.2-alpha.4', '0.1.2-alpha.4') === 'unchanged')
assertContract('an older stable candidate is not newer than a declared alpha', classifyCandidateVersion('0.1.1-rc.2', '0.1.2-alpha.4') === 'not-newer')
assertContract(
  'later prereleases and stable releases supersede a declared alpha',
  classifyCandidateVersion('0.1.2-alpha.5', '0.1.2-alpha.4') === 'newer'
    && classifyCandidateVersion('0.1.2', '0.1.2-alpha.4') === 'newer',
)
assertContract(
  'numeric prerelease identifiers and build metadata follow semantic-version precedence',
  classifyCandidateVersion('0.1.2-alpha.10', '0.1.2-alpha.4') === 'newer'
    && classifyCandidateVersion('0.1.2-alpha.4+candidate', '0.1.2-alpha.4+declared') === 'not-newer',
)
