...
describe('OpenAI Codex proxy Detect/Test routes', () => {
  ...
  it('detects the highest-priority environment candidate without testing or mutating settings', async () => {
    ...
    expect(bodyOf(res)).toEqual({ detected: true, source: 'HTTPS_PROXY', valid: true, proxyUrl: 'http://127.0.0.1:8443' })
