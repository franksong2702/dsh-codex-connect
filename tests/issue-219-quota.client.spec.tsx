...
let hidden = false
const state: ModelDirectoryState & { pending: null } = { pending: null, current: { provider: 'openai-codex', model: 'gpt-5.1-codex' }, routable: true, groups: [], failures: [], status: 'ready', error: null }
