...
var OpenAICodexImageAssetStore = class {
	...
	async read(sessionId, assetId) {
		...
		try {
			...
			if (document === void 0 || document.sessionId !== sessionId || document.image.assetId !== assetId) return void 0;
