...
function requestProvider(provider, fastMode, getProxy) {
...
function applyContextWindowOverrides(provider, getOverrides) {
...
*/
function createOpenAICodexAdapter(credentials, resolveAttachments, fastMode, getProxyConfig, getContextWindowOverrides) {
	const provider = applyContextWindowOverrides(openaiCodexProvider(), getContextWindowOverrides ?? (() => void 0));
