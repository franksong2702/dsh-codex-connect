...
var ErrorFrameObserver = class {
	...
	observe(data) {
		...
		this.stop();
		const response = record$4(event["response"]) ? event["response"] : void 0;
		const nested = record$4(event["error"]) ? event["error"] : response !== void 0 && record$4(response["error"]) ? response["error"] : void 0;
