...
import { a as ASTRA_REASONING_EFFORTS, c as isAstraReasoningEffort, d as readReasoningUpdate, f as reasoningUpdateError, l as planReasoningUpdates, o as applyReasoningUpdates, s as createReasoningUpdateMessage, u as readReasoningSelectionOrdinal } from "./history-migration-t1ELOIxe.js";
...
import { ReasoningEffortId, createUserMessage, resolveRetryPolicy } from "@deepseek-ai/dsh-llm";
...
function pendingSelection(session) {
	...
	if (events.some((event) => event.seq > selection.seq && event.type === "user/message" && readReasoningUpdate(event.data) !== void 0 && (readReasoningSelectionOrdinal(event.data) === ordinal || "reasoningSelectionSeq" in event.data.source && event.data.source.reasoningSelectionSeq === selection.seq))) return void 0;
	...
	ctx.on("agent/pre-step", async ({ agent }, next) => {
		...
		if (selected !== void 0 && base !== void 0 && isAstraReasoningEffort(selected.reasoningEffort)) {
			...
			if (selected.reasoningEffort !== previous.effectiveEffort) {
				const notice = createReasoningUpdateMessage({
					version: 1,
					sessionId: agent.id,
					baseEffort: base,
...
//#endregion
export { OPENAI_CODEX_PROXY_TEST_PATH as $, openAICodexConflictMessage as A, openAICodexModelCatalog as At, DSH_PLUGIN_API_PACKAGES as B, OpenAICodexCredentialStore as Bt, OpenAICodexTransport as C, OPENAI_CODEX_FAST_MODE_MAX_SESSION_ID_LENGTH as Ct, IMAGE_GENERATE_TOOL_NAME as D, OPENAI_CODEX_USAGE_URL as Dt, VIEW_IMAGE_TOOL_NAME as E, normalizeTrustedOrigin as Et, parseOpenAICodexUpdateResult as F, OPENAI_CODEX_ACCOUNT_LIMIT as Ft, SUPPORTED_NODE_RANGE as G, SUPPORTED_DSH_PLUGIN_API_RANGE as H, parseOpenAICodexVersion as I, OPENAI_CODEX_AUTH_DOCUMENT_LIMIT as It, detectCompatibility as J, SUPPORTED_PI_AI_RANGE as K, COMPATIBILITY_CONTRACT as L, OPENAI_CODEX_AUTH_FILENAME as Lt, OPENAI_CODEX_UPDATE_PATH as M, logoutOpenAICodex as Mt, checkForOpenAICodexUpdate as N, openAICodexAuthStatus as Nt, assertNoOpenAICodexProviderConflict as O, parseOpenAICodexUsage as Ot, compareOpenAICodexVersions as P, publicAuthError as Pt, OPENAI_CODEX_PROXY_DETECT_PATH as Q, COMPATIBILITY_PACKAGES as R, OPENAI_CODEX_AUTH_V1_BACKUP_SUFFIX as Rt, OPENAI_CODEX_TRANSPORT_SERVICE as S, OPENAI_CODEX_FAST_MODE_MAX_SESSIONS as St, isOpenAICodexTransportError as T, OpenAICodexTrustedOriginsStore as Tt, SUPPORTED_DSH_PLUGIN_API_VERSION as U, PI_AI_PACKAGE as V, openAICodexAuthPath as Vt, SUPPORTED_DSH_PLUGIN_API_VERSIONS as W, isSupportedDshPluginApiVersion as X, evaluateCompatibility as Y, readInstalledPackageVersion as Z, OPENAI_CODEX_IMAGE_MAX_RESPONSE_BYTES as _, normalizeOpenAICodexProxyUrl as _t, name as a, detectOpenAICodexProxies as at, OPENAI_CODEX_TRANSPORT_API_VERSION as b, OPENAI_CODEX_FAST_MODE_PATH as bt, probeCodexAutoReview as c, DEFAULT_OPENAI_CODEX_SEARCH_CONTEXT_SIZE as ct, OPENAI_CODEX_SEARCH_URL as d, DEFAULT_OPENAI_CODEX_SEARCH_MODEL as dt, OPENAI_CODEX_LOCAL_PROXY_CANDIDATES as et, OpenAICodexSearchProvider as f, DEFAULT_OPENAI_CODEX_SETTINGS as ft, OPENAI_CODEX_IMAGE_MAX_ERROR_BYTES as g, isValidOpenAICodexProxyUrl as gt, OPENAI_CODEX_IMAGE_MAX_COUNT as h, isValidOpenAICodexContextWindowOverrides as ht, inject as i, OpenAICodexProxyManager as it, CODEX_CONNECT_VERSION as j, loginOpenAICodex as jt, diagnoseOpenAICodex as k, readOpenAICodexRateLimits as kt, OPENAI_CODEX_BASE_URL as l, DEFAULT_OPENAI_CODEX_SEARCH_MAX_OUTPUT_TOKENS as lt, OPENAI_CODEX_IMAGE_GENERATION_URL as m, decodeOpenAICodexSettings as mt, OPENAI_CODEX_SETTINGS_NS as n, OPENAI_CODEX_PROXY_PROBE_TIMEOUT_MS as nt, ASTRA_REASONING_TOOL_NAME as o, listOpenAICodexProxyCandidates as ot, mapOpenAICodexSearchResponse as p, OPENAI_CODEX_SETTINGS_NAMESPACE as pt, assessCompatibility as q, apply as r, OPENAI_CODEX_PROXY_PROBE_URL as rt, CODEX_AUTO_REVIEW_MODEL as s, DEFAULT_OPENAI_CODEX_PROXY_URL as st, Config as t, OPENAI_CODEX_PROXY_CANDIDATE_LIMIT as tt, OPENAI_CODEX_SEARCH_PROVIDER as u, DEFAULT_OPENAI_CODEX_SEARCH_MODE as ut, OPENAI_CODEX_IMAGE_PROMPT_MAX_LENGTH as v, resolveOpenAICodexProxyUrl as vt, OpenAICodexTransportError as w, isFastModeSessionId as wt, OPENAI_CODEX_TRANSPORT_ERROR_CODES as x, FastModeRegistry as xt, OPENAI_CODEX_IMAGE_REQUEST_TIMEOUT_MS as y, resolveOpenAICodexSettings as yt, COMPATIBILITY_SCHEMA_VERSION as z, OPENAI_CODEX_PROVIDER as zt };
