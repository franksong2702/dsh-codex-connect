		...
		const routes = [
			...
			ctx.webServer.register({
				...
				handler: async (req, res) => {
					if (req.method !== "GET") return json$2(res, 405, { error: "method not allowed" });
					if (!await authorize(req, res)) return;
					json$2(res, 200, detectOpenAICodexProxyEnvironment(environment));
				}
			}),
			ctx.webServer.register({
				kind: "exact",
...
//#endregion
export { DEFAULT_OPENAI_CODEX_PROXY_URL as $, openAICodexConflictMessage as A, OPENAI_CODEX_AUTH_FILENAME as At, DSH_PLUGIN_API_PACKAGES as B, OpenAICodexTransport as C, OPENAI_CODEX_CONNECTIVITY_TARGETS as Ct, IMAGE_GENERATE_TOOL_NAME as D, OpenAICodexProxyController as Dt, VIEW_IMAGE_TOOL_NAME as E, OPENAI_CODEX_PROXY_TEST_URL as Et, parseOpenAICodexUpdateResult as F, assessCompatibility as G, SUPPORTED_DSH_PLUGIN_API_VERSION as H, parseOpenAICodexVersion as I, OPENAI_CODEX_CONNECTIVITY_PATH as J, detectCompatibility as K, COMPATIBILITY_CONTRACT as L, OPENAI_CODEX_UPDATE_PATH as M, OpenAICodexCredentialStore as Mt, checkForOpenAICodexUpdate as N, openAICodexAuthPath as Nt, assertNoOpenAICodexProviderConflict as O, checkOpenAICodexConnectivity as Ot, compareOpenAICodexVersions as P, detectOpenAICodexProxyEnvironment as Q, COMPATIBILITY_PACKAGES as R, OPENAI_CODEX_TRANSPORT_SERVICE as S, openAICodexAuthStatus as St, isOpenAICodexTransportError as T, OPENAI_CODEX_PROXY_TEST_TIMEOUT_MS as Tt, SUPPORTED_NODE_RANGE as U, PI_AI_PACKAGE as V, SUPPORTED_PI_AI_VERSION as W, OPENAI_CODEX_PROXY_TEST_PATH as X, OPENAI_CODEX_PROXY_DETECT_PATH as Y, OPENAI_CODEX_PROXY_ENV_KEYS as Z, OPENAI_CODEX_IMAGE_MAX_RESPONSE_BYTES as _, OPENAI_CODEX_USAGE_URL as _t, name as a, OPENAI_CODEX_SETTINGS_NAMESPACE as at, OPENAI_CODEX_TRANSPORT_API_VERSION as b, loginOpenAICodex as bt, migrateOpenAICodexSearchHistory as c, resolveOpenAICodexProxyUrl as ct, OPENAI_CODEX_SEARCH_URL as d, FastModeRegistry as dt, DEFAULT_OPENAI_CODEX_SEARCH_CONTEXT_SIZE as et, OpenAICodexSearchProvider as f, OPENAI_CODEX_FAST_MODE_MAX_SESSIONS as ft, OPENAI_CODEX_IMAGE_MAX_ERROR_BYTES as g, normalizeTrustedOrigin as gt, OPENAI_CODEX_IMAGE_MAX_COUNT as h, OpenAICodexTrustedOriginsStore as ht, inject as i, DEFAULT_OPENAI_CODEX_SETTINGS as it, CODEX_CONNECT_VERSION as j, OPENAI_CODEX_PROVIDER as jt, diagnoseOpenAICodex as k, testOpenAICodexProxy as kt, OPENAI_CODEX_BASE_URL as l, resolveOpenAICodexSettings as lt, OPENAI_CODEX_IMAGE_GENERATION_URL as m, isFastModeSessionId as mt, OPENAI_CODEX_SETTINGS_NS as n, DEFAULT_OPENAI_CODEX_SEARCH_MODE as nt, OPENAI_CODEX_HISTORY_BACKUP_SUFFIX as o, decodeOpenAICodexSettings as ot, mapOpenAICodexSearchResponse as p, OPENAI_CODEX_FAST_MODE_MAX_SESSION_ID_LENGTH as pt, evaluateCompatibility as q, apply as r, DEFAULT_OPENAI_CODEX_SEARCH_MODEL as rt, OPENAI_CODEX_SEARCH_MODEL_REQUEST_EVENT as s, isValidOpenAICodexProxyUrl as st, Config as t, DEFAULT_OPENAI_CODEX_SEARCH_MAX_OUTPUT_TOKENS as tt, OPENAI_CODEX_SEARCH_PROVIDER as u, OPENAI_CODEX_FAST_MODE_PATH as ut, OPENAI_CODEX_IMAGE_PROMPT_MAX_LENGTH as v, parseOpenAICodexUsage as vt, OpenAICodexTransportError as w, OPENAI_CODEX_CONNECTIVITY_TIMEOUT_MS as wt, OPENAI_CODEX_TRANSPORT_ERROR_CODES as x, logoutOpenAICodex as xt, OPENAI_CODEX_IMAGE_REQUEST_TIMEOUT_MS as y, readOpenAICodexRateLimits as yt, COMPATIBILITY_SCHEMA_VERSION as z };
