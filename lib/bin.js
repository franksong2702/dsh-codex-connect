...
async function probeCodexResponses(request, createDispatcher = (proxyUrl) => proxyUrl === void 0 ? new Agent() : new ProxyAgent(proxyUrl)) {
	...
	const deadline = openAICodexBackendDeadline(void 0, request.timeoutMs);
	...
	try {
		...
		return {
			outcome: deadline.timedOut() ? "timeout" : "network-error",
