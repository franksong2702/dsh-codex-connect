	...
	factory: (require) => {
						...
						children: [
							...
							/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								...
								children: [
									...
									/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
										role: "group",
										"aria-labelledby": `${panelPrefix}-think-label`,
										style: {
											display: "flex",
											flexDirection: "column",
											gap: 6
										...
										children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("label", {
											...
											children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("input", {
												...
												onChange: (event) => {
													update("enableReasoningUpdates", event.currentTarget.checked);
												}
											}), /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
												style: {
													...toggleCopyStyle,
												...
												children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
													...
													children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
														id: `${panelPrefix}-think-label`,
														style: labelStyle,
														children: t("enableReasoningUpdates")
													}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
														style: badgeStyle,
														children: t("reasoningUpdatesBadge")
													})]
												}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
													id: `${panelPrefix}-think-help`,
													style: bodyStyle$2,
													children: t("enableReasoningUpdatesHelp")
												})]
											})]
										}), /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
											style: {
											...
											children: [
												/* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
													id: `${panelPrefix}-think-consent`,
													style: bodyStyle$2,
													children: t("reasoningUpdatesConsent")
												}),
												snapshot.status === "ready" && snapshot.value !== void 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("p", {
													style: bodyStyle$2,
													role: "status",
													children: [t(snapshot.value.enableReasoningUpdates ? "reasoningUpdatesSavedOn" : "reasoningUpdatesSavedOff"), draft.enableReasoningUpdates !== snapshot.value.enableReasoningUpdates ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
														style: { marginLeft: 8 },
														children: t("reasoningUpdatesPending")
													}) : null]
												}) : null,
												/* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
													id: `${panelPrefix}-think-risk`,
													style: bodyStyle$2,
													children: t("reasoningUpdatesRisk")
												}),
												/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("details", { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("summary", {
													...
													children: t("reasoningUpdatesDetails")
												}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
													style: {
														...bodyStyle$2,
														marginTop: 6
													},
													children: t("reasoningUpdatesDisableHelp")
												})] })
											]
										})]
									}),
		...
		*/
		...
		const en = {
			...
			enableReasoningUpdates: "Codex native reasoning adjustment (Astra)",
			enableReasoningUpdatesHelp: "Let Astra suggest more reasoning for difficult work or less for routine steps, using Codex native configuration updates within this conversation. Each change is yours to approve; quality, speed and quota savings are not guaranteed.",
			reasoningUpdatesBadge: "Experimental · off by default",
			reasoningUpdatesConsent: "Enable and save to allow suggestions, not automatic effort changes. Each proposed level requires an explicit answer in the native question card. Pending approval does not change the current request, other conversations or defaults.",
			reasoningUpdatesSavedOn: "Saved: reasoning suggestions enabled",
			reasoningUpdatesSavedOff: "Saved: reasoning suggestions disabled",
			reasoningUpdatesPending: "Reasoning setting not saved",
			reasoningUpdatesRisk: "Use an Astra main conversation with an explicit initial effort, not Default. Verified prefix compaction can preserve admitted adjustments through the host journal; it does not enable native compaction automatically. Model switches, inherited child histories, and arbitrary history rewrites remain unsupported. Live quality and savings are not yet established.",
			reasoningUpdatesDetails: "When changes apply and what disabling does",
			reasoningUpdatesDisableHelp: "The selector follows the next recorded request, not the click on Approve. A later manual choice takes priority. Disable and save to cancel open questions and unadmitted changes. Previously recorded adjustments still replay; disabling does not reset the current effort or remove the experimental-history limits.",
		...
		const zh = {
			...
			enableReasoningUpdates: "Codex 原生推理强度调整（Astra）",
			enableReasoningUpdatesHelp: "让 Astra 根据接下来的工作，建议在难题上多想一些、在常规步骤上少想一些，并通过 Codex 原生配置更新在当前会话内调整。每次调整由你批准；不保证质量、速度或额度收益。",
			reasoningUpdatesBadge: "实验性 · 默认关闭",
			reasoningUpdatesConsent: "开启并保存只允许提出建议，不授权自动改变推理强度。每个目标档位都需要你在原生问询卡中明确确认；待批准状态不会改变当前请求、其他会话或全局默认设置。",
			reasoningUpdatesSavedOn: "当前已保存：允许推理调整建议",
			reasoningUpdatesSavedOff: "当前已保存：推理调整建议关闭",
			reasoningUpdatesPending: "推理设置尚未保存",
			reasoningUpdatesRisk: "请使用 Astra 主会话，并明确选择初始档位，不要使用 Default。通过宿主日志验证的前缀压缩可以保留已生效的调档，但不会自动开启原生压缩。仍不支持切换模型、继承子会话历史或任意历史改写；尚未证明真实任务的质量或用量收益。",
			reasoningUpdatesDetails: "生效时机与关闭后的行为",
			reasoningUpdatesDisableHelp: "档位选择器跟随下一次正式记录的请求，而不是点击批准时立即改变。后来的手动选择优先。关闭并保存会取消尚未完成的问询和未进入请求的变更；已记录的调整继续回放，不会自动降档，也不会解除实验历史的限制。",
		...
		*/
		...
		const words = {
			en: {
				...
				models: "Allowed models and effort levels",
				eligibility: "Model capability is from the installed adapter. Your account eligibility has not been probed; an unavailable model will not be silently replaced.",
			...
			zh: {
				...
				models: "允许使用的模型与档位",
				eligibility: "能力来自已安装的适配器，尚未探测你的账户资格。模型不可用时会报明原因，不会偷偷换成其他模型。",
				start: "按这些范围开始",
				manual: "切回手动",
				stop: "停止这项任务",
				resume: "按原范围继续",
		...
		function AdaptiveTaskControl({ sessionId, language = "en" }) {
			...
			const label = state?.unavailable === "TASK_STOPPING" ? text.stopping : state?.mode === "auto" ? text.active : state?.mode === "interrupted" ? text.interrupted : state?.mode === "stopped" ? text.stopped : state?.mode === "limit" ? text.limit : text.off;
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
				ref: opener,
				type: "button",
				style: buttonStyle,
				...
				children: [
					...
					state !== void 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [
						/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("p", { children: [
							text.current,
							": ",
							state.current ? format(state.current) : text.notStarted,
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [
							state?.mode === "off" ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
								style: buttonStyle,
								type: "button",
								disabled: busy || failed || !state.canStart || !Number.isSafeInteger(maximum) || maximum < 1 || maximum > 200,
								onClick: () => {
									mutate("start");
								},
								children: text.start
