    ...
    ` }), /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
		...
		*/
		...
		function OpenAICodexProxyIndicator({ directory, configScope, sessionKey, t }) {
			...
			const [refreshRevision, setRefreshRevision] = (0, react.useState)(0);
			...
			(0, react.useEffect)(() => {
				...
				const refresh = async () => {
					...
					try {
						...
						if (!stopped && !requestController.signal.aborted) setConnectivityError(error instanceof Error ? error.message : String(error));
					} finally {
						inFlight = false;
      ...
      ` }),
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
						...
						style: {
							...
							marginTop: FLOW_LIGHT_GAP,
							padding: "3px 5px",
							border: "1px solid var(--dsw-alias-border-l2)",
							borderRadius: 999,
							background: "color-mix(in srgb, var(--dsw-alias-bg-layer-1, #fff) 92%, transparent)",
							boxShadow: "0 3px 9px rgb(0 0 0 / 13%), inset 0 1px 0 rgb(255 255 255 / 32%)",
							backdropFilter: "blur(8px)"
						},
						children: CONNECTIVITY_LIGHTS.map((light) => {
							const target = report?.targets.find((candidate) => candidate.id === light.id);
							const lightSignal = connectivityError !== void 0 ? "red" : target === void 0 ? "yellow" : targetSignal(target);
							...
							/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("section", {
								...
								children: [
									...
									/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("select", {
										...
										children: [accounts.length === 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("option", {
											value: "",
											children: t("accountUnavailable")
										}) : null, accounts.map((account, index) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)("option", {
											value: account.accountId,
											children: t("accountOption", {
												index: index + 1,
												suffix: accountSuffix(account.accountId)
											})
										}, account.accountId))]
									}),
		...
		const en = {
			...
			accountSwitcherHeading: "Codex accounts",
			accountSwitcherHelp: "Each subaccount keeps its own OAuth tokens. Switching affects new Codex requests.",
		...
		const zh = {
			...
			accountSwitcherHeading: "Codex 多账户",
			accountSwitcherHelp: "每个子账户保存独立 OAuth 凭据；切换后对新的 Codex 请求生效。",
