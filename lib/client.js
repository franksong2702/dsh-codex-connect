	...
	factory: (require) => {
		...
		*/
		...
		const en = {
			...
			enableReasoningUpdatesHelp: "Let the agent propose a reasoning change in this conversation. Every change requires your answer; Auto-review cannot approve it. Use an explicit initial Astra level. Compaction and model switching are unsupported; the selector keeps the original level.",
		...
		const zh = {
			...
			enableReasoningUpdatesHelp: "允许代理提议调整当前会话的推理档位，每次都需要你回答，自动审查不能代为确认。须显式选择 Astra 初始档位；暂不支持压缩和切换模型，选择器仍显示初始档位。",
