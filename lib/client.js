	...
	factory: (require) => {
		...
		var OpenAICodexUpdateStore = class {
			...
			async refresh(force = false) {
				...
				try {
					...
					const currentDshVersion = runtimeResponse.ok && typeof rawCurrentDshVersion === "string" && parseOpenAICodexVersion(rawCurrentDshVersion) !== void 0 ? rawCurrentDshVersion : void 0;
					const currentDsh = currentDshVersion === void 0 ? {} : { currentDshVersion };
					if (!force) {
						const cached = this.readCached();
						if (cached !== void 0) {
							this.setSnapshot(resultSnapshot({
								...cached,
								...currentDsh
							}, this.dismissedNotice()));
							return;
						}
					}
		...
		function UpdateContents({ updater, t, overlay }) {
			...
			if (compatibility?.status === "compatible") {
				if (snapshot.currentDshVersion === void 0 || compatibility.latestDshVersion === void 0) {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					compatibility === void 0 ? null : /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						"data-compatibility-status": displayedCompatibilityStatus,
						children: [
							/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("strong", {
								style: titleStyle$1,
								children: [
									compatibilityIcons[displayedCompatibilityStatus ?? compatibility.status],
									" ",
		...
		*/
		...
		const en = {
			...
			compatibilityCurrentTitle: "Up to date and compatible",
		...
		const zh = {
			...
			compatibilityCurrentTitle: "已是最新，兼容正常",
		...
		*/
		...
		const CODEX_CONNECT_VERSION = "0.1.0-alpha.4.16";
		//#endregion
