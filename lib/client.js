window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region src/client/config-forms.ts
		/** Narrow an unknown value to the config-forms service shape. */
		function isConfigForms(value) {
		...
		*/
		function configFormsOf(ctx) {
			...
			return isConfigForms(value) ? value : void 0;
		}
		/** Narrow an unknown value to the legacy settings-scope service shape. */
		function isLegacySettingsScope(value) {
			if (typeof value !== "object" || value === null) return false;
		...
		*/
		function legacySettingsScopeOf(ctx) {
			const value = ctx.get("settingsScope");
			return isLegacySettingsScope(value) ? value : void 0;
		}
		//#endregion
		...
		*/
		...
		function apply(ctx) {
			...
			if (configForms !== void 0) ctx.inject(["configForms"], (formsCtx) => {
				const configScope = formsCtx.configForms.get(OPENAI_CODEX_SETTINGS_NAMESPACE);
			...
			else if (legacySettings !== void 0) ctx.inject(["settingsScope"], (scopeCtx) => {
