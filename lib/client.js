	...
	factory: (require) => {
		...
		function OpenAICodexProxyConfiguration({ scope, t, compact = false }) {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("section", {
				...
				children: [
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
						style: active ? successStyle : errorStyle$2,
						role: "status",
						children: statusText
					}),
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("label", {
		...
		function OpenAICodexQuotaIndicator({ directory, t }) {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
				...
				children: [quotas.map((quota) => {
					...
					children: quotas.map((quota) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
						style: { display: "block" },
						children: quota.summary
					}, quota.kind))
				}) : null]
			});
		}
		...
		*/
		...
		function OpenAICodexProxyIndicator({ directory, configScope, sessionKey, t }) {
			...
			const panelWidth = Math.max(220, Math.min(400, (bounds?.width ?? 432) - 32));
			...
			const popupStyle = {
				...
				padding: 14,
				border: "1px solid var(--dsw-alias-border-l2)",
				borderRadius: openRight ? openDown ? "8px 22px 22px 22px" : "22px 22px 22px 8px" : openDown ? "22px 8px 22px 22px" : "22px 22px 8px 22px",
      ...
      ` }),
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("button", {
						...
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
							...
							style: {
								position: "relative",
								zIndex: 1,
								textShadow: "0 1px 3px rgb(0 36 76 / 65%)"
							},
							children: "PROXY"
						})]
					}),
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
						...
						children: CONNECTIVITY_LIGHTS.map((light, index) => {
						...
						children: [
							/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("strong", {
									...
									children: checking ? t("connectivityRefreshing") : t("connectivityRefresh")
								})]
							}),
							/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								role: "list",
										...
										children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
											...
											children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
												...
												style: {
													...
													boxShadow: `0 0 0 3px color-mix(in srgb, ${signalColors[targetState]} 16%, transparent)`
												}
											}), target.hostname]
										}), detailsVisible ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
											"data-openai-codex-domain-details": target.id,
											style: {
												marginTop: 6,
												color: targetState === "red" ? "var(--dsw-alias-state-error-primary, #d92d20)" : "var(--dsw-alias-label-secondary)",
												fontSize: 11,
												lineHeight: "16px",
												overflowWrap: "anywhere"
											},
											children: target.reachable ? t("connectivityReachable", { latency: target.latencyMs }) : target.error ?? t("connectivityUnreachable", { latency: target.latencyMs })
										}) : null]
									}, target.id);
