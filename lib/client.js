	...
	factory: (require) => {
		...
		function UpdateContents({ updater, t, overlay }) {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					snapshot.status === "idle" || snapshot.status === "checking" ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
					...
					}) : snapshot.status === "up-to-date" ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
						style: bodyStyle$1,
						...
						details ? snapshot.releaseNotes === void 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
							style: bodyStyle$1,
						...
						/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							...
							children: [
								/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
									...
									children: details ? t("hideReleaseNotes") : t("viewReleaseNotes")
								}),
								/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
									type: "button",
									style: buttonStyle$1,
		...
		*/
		...
		const en = {
			...
			upgradeCommandHelp: "Copy this command and run it in the terminal. The plugin will not run it automatically:",
			dismissUpdate: "Later"
		};
		...
		const zh = {
			...
			upgradeCommandHelp: "复制下面的命令，在终端中执行。插件不会自动执行：",
			dismissUpdate: "稍后提醒"
		};
		//#endregion
