window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		//#endregion
		//#region src/client/TaskDelegationConsent.tsx
		/** Optional section of the existing task dialog; hidden unless the host advertises v2 control. */
		function TaskDelegationConsent({ state, zh, disabled, mutate }) {
			const [files, setFiles] = (0, react.useState)(""), [choices, setChoices] = (0, react.useState)([]);
			const [requests, setRequests] = (0, react.useState)(6), [seconds, setSeconds] = (0, react.useState)(90), [disclose, setDisclose] = (0, react.useState)(false);
			const d = state.delegation;
			if (d === void 0) return null;
			const text = (en, cn) => zh ? cn : en;
			const status = (value) => zh ? {
				prepared: "已准备",
				running: "运行中",
				settling: "正在收尾",
				succeeded: "已完成",
			...
			const routes = state.capabilities.flatMap((model) => model.efforts.map((effort) => ({
				model: model.model,
				effort
			})));
			const selected = routes.filter((route) => choices.includes(`${route.model}/${route.effort}`));
			const paths = files.split("\n").map((path) => path.trim()).filter(Boolean);
			const canSave = !disabled && d.idle && ["auto", "interrupted"].includes(state.mode) && disclose && selected.length > 0 && paths.length > 0 && paths.length <= 32 && new Set(paths).size === paths.length && Number.isInteger(requests) && requests >= 1 && requests <= 6 && Number.isInteger(seconds) && seconds >= 1 && seconds <= 90;
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("section", {
				"aria-label": text("Optional read-only helper", "可选只读子任务"),
				children: [
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("h3", { children: text("Optional read-only helper", "可选只读子任务") }),
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", { children: text("Off unless separately authorized. One helper at a time; the parent waits. No edits, shell, web tools or nested delegation. Its requests share the task limit; no cost or quality benefit is promised.", "未单独授权就不会开启。一次只运行一个子任务，主任务等待；不能修改文件、执行命令、使用网络工具或继续委派。请求共用整项任务上限，不保证更省或更好。") }),
					d.version === 1 ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", { children: text("Prepare this idle task for optional delegation. Spent requests stay counted; the task pauses and requires explicit resume. This does not grant a helper access to files.", "准备迁移这项空闲任务：已用次数保留，迁移后暂停并等待明确恢复。这一步不会授权子任务读取文件。") }), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
						type: "button",
						disabled: disabled || !d.idle,
						onClick: () => mutate("upgrade"),
						children: text("Prepare task upgrade", "准备任务升级")
					})] }) : /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [
						/* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", { children: d.enabled ? text("Read-only delegation is authorized for:", "已授权只读委派范围：") : text("No delegation permission", "尚未授予委派权限") }),
						d.enabled ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							style: { overflowWrap: "anywhere" },
							children: [
								/* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", { children: d.routes.map((route) => `${route.model} / ${route.effort}`).join(", ") }),
								/* @__PURE__ */ (0, react_jsx_runtime.jsx)("ul", { children: d.files.map((file) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)("li", { children: file }, file)) }),
								/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("p", { children: [
									text("Per helper:", "每个子任务："),
									" ",
									d.maxRequests,
									" ",
									text("requests,", "次请求，"),
						...
						/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("details", { children: [
							/* @__PURE__ */ (0, react_jsx_runtime.jsx)("summary", { children: text("Set explicit helper scope", "设置明确的子任务范围") }),
							/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("fieldset", {
								disabled: disabled || !d.idle,
								children: [
									/* @__PURE__ */ (0, react_jsx_runtime.jsx)("legend", { children: text("Allowed child models and effort levels", "允许的子模型与档位") }),
									routes.map((route) => {
										...
										return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("label", {
											...
											children: [
												/* @__PURE__ */ (0, react_jsx_runtime.jsx)("input", {
													type: "checkbox",
													"aria-label": `Child ${route.model} / ${route.effort}`,
									...
									/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("label", {
										style: { display: "block" },
										children: [text("Approved text files (workspace-relative, one per line)", "批准的文本文件（相对工作目录，每行一个）"), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("textarea", {
											rows: 3,
											value: files,
									...
									/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("label", {
										style: { display: "block" },
										children: [text("Requests per helper", "每个子任务的请求上限"), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("input", {
											type: "number",
											min: 1,
											max: 6,
											value: requests,
									...
									/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("label", {
										style: { display: "block" },
										children: [text("Timeout in seconds", "超时秒数"), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("input", {
											type: "number",
											min: 1,
											max: 90,
											value: seconds,
									...
									/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("label", {
										...
										}), text("I reviewed these files and allow their contents to be sent to the selected models. Filename filters cannot guarantee that text is free of secrets.", "我已检查这些文件，同意将内容发送给所选模型。文件名过滤不能保证文本中没有秘密。")]
									})
								]
							}),
							/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
								type: "button",
								disabled: !canSave,
								onClick: () => mutate("delegate-enable", {
									files: paths,
									routes: selected,
									maxChildRequests: requests,
									timeoutMs: seconds * 1e3,
									disclose: true
								}),
								children: text("Authorize exactly this scope", "仅授权这些范围")
							})
						] }),
						/* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", { children: text("Stop and manual takeover also cancel the helper. Scope changes require an idle task. Unknown delivery or unverified cleanup blocks further delegation and downgrade.", "停止与手动接管也会取消子任务。修改范围需要任务空闲；送达未知或清理未确认时，不能继续委派或降级。") }),
						d.runs.length ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("ul", {
							"aria-label": text("Child outcomes", "子任务状态"),
							children: d.runs.map((run, index) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("li", {
								style: { overflowWrap: "anywhere" },
								children: [
									"#",
									index + 1,
						...
						/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
								type: "button",
								disabled: disabled || !d.idle || !d.enabled,
								onClick: () => mutate("delegate-disable"),
								children: text("Remove helper permission", "撤销子任务权限")
							}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
								type: "button",
								disabled: disabled || !d.canDowngrade,
								onClick: () => mutate("downgrade"),
								children: text("Archive and return to Phase 1 manual", "留档并退回 Phase 1 手动模式")
							})]
						}),
						/* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", { children: text("Downgrade requires manual mode, removed helper permission and confirmed child delivery/cleanup. History and spent requests are retained; nothing is deleted or refunded.", "降级要求先切回手动、撤销子任务权限，并确认结果送达和清理。历史与已用次数保留，不删除，也不退回次数。") })
					] })
				]
			});
		}
		...
		const words = {
			en: {
				...
				scope: "Main model and effort allowed if started now: ",
		...
		const format = (value) => `${value.model} / ${value.effort}`;
					...
					state !== void 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [
						...
						state.mode === "off" ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [
							...
							/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("p", {
								"aria-live": "polite",
								style: { overflowWrap: "anywhere" },
								children: [text.scope, models.map((model) => `${model}: ${(efforts[model] ?? []).join(", ") || "—"}`).join("; ")]
							}),
							/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("label", {
								style: {
									display: "block",
						...
						/* @__PURE__ */ (0, react_jsx_runtime.jsx)(TaskDelegationConsent, {
							state,
							zh: language === "zh",
