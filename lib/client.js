	...
	factory: (require) => {
		...
		*/
		...
		function OpenAICodexSettings({ t, configScope, updater, account, embedded = false, accountOnly = false }) {
			...
			const { status, busy, loginUrl } = (0, react.useSyncExternalStore)(store.subscribe, store.getSnapshot);
			const [copied, setCopied] = (0, react.useState)(false);
			const [copyFailed, setCopyFailed] = (0, react.useState)(false);
						...
						/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							...
							children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								...
								children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
									...
									children: busy ? t("working") : t("reopenAuthorization")
								}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
									type: "button",
									style: buttonStyle,
									disabled: busy,
		...
		*/
		...
		const en = {
			...
			modelsAccountHelp: "Proxy, model visibility, search and image options remain in Settings → Plugins → Codex Connect.",
		...
		const zh = {
			...
			modelsAccountHelp: "代理、模型显示、搜索和图片选项仍在“设置 → 插件 → Codex Connect”中管理。",
			expand: "展开设置",
			collapse: "折叠设置",
		...
		*/
		...
		function OpenAICodexModelsCard({ t, account }) {
			const [expanded, setExpanded] = (0, react.useState)(false);
			const detailsId = (0, react.useId)();
			const { status } = (0, react.useSyncExternalStore)(account.subscribe, account.getSnapshot);
			const label = accountStatusLabel(status.status, t);
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				style: {
					border: "1px solid var(--dsw-alias-border-l2)",
				...
				children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					...
					children: [
						...
						/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
							...
							children: expanded ? t("collapse") : t("manageAccount")
						})
					]
