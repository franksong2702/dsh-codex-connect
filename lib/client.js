window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		function weeklyQuotaOf(usage) {
			return usage.rateLimits.find((limit) => limit.id === "codex")?.windows.find((window) => window.windowSeconds === WEEK_SECONDS);
		}
		...
		function formatCompactResetAt(resetAt) {
			if (resetAt === void 0 || !Number.isSafeInteger(resetAt) || resetAt <= 0) return void 0;
			const date = /* @__PURE__ */ new Date(resetAt * 1e3);
			if (!Number.isFinite(date.getTime())) return void 0;
			return new Intl.DateTimeFormat(void 0, {
		...
		function OpenAICodexQuotaIndicator({ directory, t }) {
			const eligible = isGptModel((0, react.useSyncExternalStore)((listener) => subscribeDirectory(directory, listener), () => directory.getSnapshot(), () => directory.getSnapshot()));
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
				...
				children: [
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", { children: [percent, "%"] }),
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
						"aria-hidden": "true",
						children: "·"
					}),
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { children: compactResetTime })
				]
			});
		}
		//#endregion
