	...
	factory: (require) => {
		...
		*/
		...
		const en = {
			...
			compatibilityDshUpdateTitle: "Update DSH to keep the latest Codex Connect",
			compatibilityDshUpdateBody: "The latest Codex Connect is verified with DSH {latestDshVersion}. Update DSH first, then update Codex Connect too if this card shows a newer plugin version.",
		...
		const zh = {
			...
			compatibilityDshUpdateTitle: "升级 DSH 以继续使用最新版 Codex Connect",
			compatibilityDshUpdateBody: "最新版 Codex Connect 已与 DSH {latestDshVersion} 完成验证。请先升级 DSH；如果卡片同时显示了更新的插件版本，再一并升级 Codex Connect。",
