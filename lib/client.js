	...
	factory: (require) => {
		...
		*/
		...
		function parseOpenAICodexDshCompatibilityAdvice(value, latestPluginVersion) {
			...
			if (status !== "compatible" && status !== "plugin-update-required" && status !== "plugin-version-required" && status !== "not-yet-compatible" && status !== "unverified") return void 0;
			...
			if (status === "plugin-version-required") {
				...
				if (typeof recommendedPluginVersion !== "string" || parseOpenAICodexVersion(recommendedPluginVersion) === void 0 || recommendedPluginVersion === latestPluginVersion) return void 0;
				return {
					status,
					latestPluginVersion,
					latestDshVersion,
		...
		function UpdateContents({ updater, t, overlay }) {
			...
			const compatibilityWarning = compatibility?.status === "plugin-update-required" || compatibility?.status === "plugin-version-required" || compatibility?.status === "not-yet-compatible";
				...
				children: [
					...
					compatibility === void 0 ? null : /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [
							...
							/* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
								style: bodyStyle$1,
								children: compatibility.status === "plugin-version-required" ? t("compatibilityPluginVersionBody", {
								...
								}) : t(compatibilityBodyKey ?? compatibilityBodyKeys[compatibility.status])
							}),
							compatibility.status === "plugin-version-required" ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("a", {
								href: `${OPENAI_CODEX_REPOSITORY_URL}/releases/tag/v${compatibility.recommendedPluginVersion}`,
								target: "_blank",
								rel: "noopener noreferrer",
								style: textButtonStyle,
								children: t("compatibilityPluginVersionAction", { version: compatibility.recommendedPluginVersion })
							}) : null,
		...
		*/
		...
		const en = {
			...
			compatibilityPluginVersionTitle: "Use the verified Codex Connect version",
			compatibilityPluginVersionBody: "DSH {dshVersion} is verified with Codex Connect {pluginVersion}. Install that version, or update DSH to {latestDshVersion} to keep using the latest plugin.",
			compatibilityPluginVersionAction: "Open Codex Connect {version} release",
		...
		const zh = {
			...
			compatibilityPluginVersionTitle: "请使用已验证的 Codex Connect 版本",
			compatibilityPluginVersionBody: "DSH {dshVersion} 已与 Codex Connect {pluginVersion} 完成验证。请安装该插件版本；如果要继续使用最新插件，请将 DSH 升级到 {latestDshVersion}。",
			compatibilityPluginVersionAction: "打开 Codex Connect {version} 发布页",
		...
		*/
		...
		const CODEX_CONNECT_VERSION = "0.1.0-alpha.4.24";
		//#endregion
