window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		function decodeOpenAICodexSettings(value) {
			...
			if (modelContextWindows !== void 0 && isRecord$2(modelContextWindows)) for (const [key, val] of Object.entries(modelContextWindows)) {
		...
		function OpenAICodexConfiguration({ scope, t }) {
			...
			const validContextWindow = draft === void 0 || draft.defaultContextWindow === 0 || Number.isInteger(draft.defaultContextWindow) && draft.defaultContextWindow > 0;
			...
			const save = async () => {
				...
				try {
					for (const field of CONFIG_FIELDS) {
						...
						if (!sameField(field, scope.getSnapshot().value?.[field], desired[field])) throw new Error(`Host refused ${field}`);
					}
					const accepted = scope.getSnapshot().value;
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("section", {
				...
				children: [
						...
						children: [
							...
							/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("label", {
								...
								children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("input", {
									...
									onChange: (event) => {
										update("proxyEnabled", event.currentTarget.checked);
									}
								}), /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
									style: toggleCopyStyle,
									children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
										style: labelStyle,
										children: t("enableProxy")
									}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
										style: bodyStyle$1,
										children: t("enableProxyHelp")
									})]
								})]
							}),
							draft.proxyEnabled ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								style: formGridStyle,
								children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("label", {
									style: formFieldStyle,
									children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
										style: labelStyle,
										children: t("proxyHost")
									}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("input", {
										style: controlStyle,
										value: draft.proxyHost,
										disabled: !editable,
										onChange: (event) => {
											update("proxyHost", event.currentTarget.value);
										}
									})]
								}), /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("label", {
									style: formFieldStyle,
									children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
										...
										disabled: !editable,
										onChange: (event) => {
											update("proxyPort", event.currentTarget.valueAsNumber);
										}
									})]
								})]
							}) : null,
							/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
								...
								children: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("label", {
									...
									children: [
										/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
											style: labelStyle,
											children: t("defaultContextWindow")
										}),
										/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
											style: bodyStyle$1,
											children: t("defaultContextWindowHelp")
										}),
										/* @__PURE__ */ (0, react_jsx_runtime.jsx)("input", {
											style: controlStyle,
											type: "number",
					...
					!validContextWindow && draft !== void 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
						style: errorStyle$1,
						role: "alert",
						children: t("invalidContextWindow")
					}) : null,
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
						style: bodyStyle$1,
		...
		*/
		...
		const en = {
			...
			enableProxy: "Enable proxy for OpenAI requests",
			enableProxyHelp: "Route OpenAI requests through a local proxy to improve connectivity and reduce latency.",
			proxyHost: "Proxy host",
			proxyPort: "Proxy port",
			defaultContextWindow: "Default context window (tokens)",
			defaultContextWindowHelp: "Override context window for all Codex models. Leave empty to use catalog defaults.",
			invalidContextWindow: "Context window must be a positive whole number.",
		...
		const zh = {
			...
			enableProxy: "启用 OpenAI 请求代理",
			enableProxyHelp: "通过本地代理路由 OpenAI 请求，以改善连接性并降低延迟。",
			proxyHost: "代理主机",
			proxyPort: "代理端口",
			defaultContextWindow: "默认上下文窗口 (tokens)",
			defaultContextWindowHelp: "覆盖所有 Codex 模型的上下文窗口。留空则使用目录默认值。",
			invalidContextWindow: "上下文窗口必须为正整数。",
