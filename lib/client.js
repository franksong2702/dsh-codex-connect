	...
	factory: (require) => {
		...
		*/
		...
		const en = {
			...
			enableImageGenerationHelp: "Use the image generation capability included with your current GPT subscription.",
		...
		const zh = {
			...
			enableImageGenerationHelp: "使用你当前 GPT 订阅计划提供的图片生成能力。",
			generating: "正在生成图片",
		...
		function CodexImageToolView({ block, sessionId, t, sessions }) {
			...
			if (!("kind" in block)) return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("section", {
				...
				children: [
					...
					prompt === void 0 ? null : /* @__PURE__ */ (0, react_jsx_runtime.jsx)(PromptPanel, {
						prompt,
						t
					})
				]
