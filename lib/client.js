	...
	factory: (require) => {
			...
			markdown.split("\n").forEach((line, index) => {
				...
				if (bullet !== null) bullets.push(/* @__PURE__ */ (0, react_jsx_runtime.jsx)("li", { children: renderInlineMarkdown(bullet[1] ?? "", `item-${index}`) }, `item-${index}`));
					...
					content.push(/* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
						...
						children: href === void 0 ? label : /* @__PURE__ */ (0, react_jsx_runtime.jsx)("a", {
							href,
							target: "_blank",
							rel: "noopener noreferrer",
							children: label
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
				...
				children: [
					...
					snapshot.status === "idle" || snapshot.status === "checking" ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
						...
						snapshot.releaseName === void 0 ? null : /* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
							style: bodyStyle$1,
							children: snapshot.releaseName
						}),
						/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							...
							}) : highlights.map((highlight) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("strong", {
								style: bodyStyle$1,
						...
						}) : renderReleaseNotes(snapshot.releaseNotes) : null,
						/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							style: actionStyle,
							children: [
								/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
		...
		*/
		...
		const en = {
			...
			upgradeStepCopy: "1. Copy the command.",
			upgradeStepRun: "2. Run it in the terminal and wait for the command to finish.",
			upgradeStepRestart: "3. Return here and check again; restart this profile’s DSH Web first if it still reports the old version.",
		...
		const zh = {
			...
			upgradeStepCopy: "1. 复制命令。",
			upgradeStepRun: "2. 在终端执行命令，并等待命令完成。",
			upgradeStepRestart: "3. 回到这里重新检查；如果仍显示旧版本，请先重启当前 profile 的 DSH Web。",
