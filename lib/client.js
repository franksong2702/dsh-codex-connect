window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		function OpenAICodexConfiguration({ scope, t }) {
			...
			const validProxy = draft !== void 0 && (!draft.enableProxy || isValidOpenAICodexProxyUrl(draft.proxyUrl.trim()));
						...
						children: [
							...
							/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("label", {
								...
								children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("input", {
									...
									onChange: (event) => {
										update("enableProxy", event.currentTarget.checked);
									}
