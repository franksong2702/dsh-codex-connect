window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		const OPENAI_CODEX_UPGRADE_COMMAND = "dsh plugin --profile web update dsh-codex-connect";
		...
		function resultSnapshot(result, dismissedVersion) {
			return {
				...
				...dismissedVersion === void 0 ? {} : { dismissedVersion }
			};
		}
		...
		var OpenAICodexUpdateStore = class {
			...
			async refresh(force = false) {
				...
				this.setSnapshot({
					...
					...this.snapshot.dismissedVersion === void 0 ? {} : { dismissedVersion: this.snapshot.dismissedVersion }
				});
				try {
			...
			markdown.split("\n").forEach((line, index) => {
				...
				if (bullet !== null) bullets.push(/* @__PURE__ */ (0, react_jsx_runtime.jsx)("li", { children: renderInlineMarkdown(bullet[1] ?? "", `item-${index}`, t) }, `item-${index}`));
					...
					content.push(/* @__PURE__ */ (0, react_jsx_runtime.jsx)("h4", {
						...
						children: renderInlineMarkdown(heading[1] ?? "", `heading-${index}`, t)
					}, `heading-${index}`));
		...
		function UpdateContents({ updater, t, overlay }) {
			...
			if (overlay && (snapshot.status !== "update-available" || latestVersion === void 0 || snapshot.dismissedVersion === latestVersion)) return null;
				...
				children: [
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("strong", {
							style: titleStyle$1,
							children: available ? t("newVersionAvailable", { version: snapshot.latestVersion }) : t("updateHeading")
						}), overlay && available ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
							type: "button",
							style: buttonStyle$1,
							"aria-label": t("dismissUpdate"),
							onClick: () => {
								if (latestVersion !== void 0) updater.dismiss(latestVersion);
							},
					...
					snapshot.status === "idle" || snapshot.status === "checking" ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
					...
					}) : snapshot.status === "up-to-date" ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
						style: bodyStyle$1,
						children: t("upToDate", { version: snapshot.currentVersion })
					}), recheckRequested ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
						style: bodyStyle$1,
						children: t("upgradeCheckSuccess", { version: snapshot.currentVersion })
						...
						/* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
							...
							children: snapshot.versionsBehind === void 0 ? t("versionSummaryUnknown", {
								current: snapshot.currentVersion,
								latest: snapshot.latestVersion
							}) : t("versionSummary", {
								current: snapshot.currentVersion,
								latest: snapshot.latestVersion,
								count: snapshot.versionsBehind
							})
						}),
						/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							...
							children: [
								...
								/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
									...
									children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("code", {
										...
										children: OPENAI_CODEX_UPGRADE_COMMAND
									}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
										type: "button",
										style: buttonStyle$1,
										onClick: () => {
										...
										children: copied ? t("upgradeCommandCopied") : t("copyUpgradeCommand")
									})]
								}),
								/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("ol", {
									style: stepsStyle,
									children: [
										/* @__PURE__ */ (0, react_jsx_runtime.jsx)("li", { children: t("upgradeStepCopy") }),
										/* @__PURE__ */ (0, react_jsx_runtime.jsx)("li", { children: t("upgradeStepRun") }),
										/* @__PURE__ */ (0, react_jsx_runtime.jsx)("li", { children: t("upgradeStepRestart") })
									]
								}),
								copyFailed ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
									style: statusStyle$1,
									children: t("upgradeCommandCopyFailed")
								}) : null,
								/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
									style: actionStyle,
									children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
					...
					!overlay ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						style: rowStyle$1,
						children: [snapshot.status !== "update-available" ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
							style: bodyStyle$1,
							children: t("currentVersion", { version: snapshot.currentVersion })
