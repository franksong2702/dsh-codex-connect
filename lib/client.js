window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		*/
		...
		const OPENAI_CODEX_CONTEXT_LIMIT_SOURCE = "https://github.com/openai/codex/blob/39598ed17885970828acd42a6370131ed0190a98/codex-rs/models-manager/models.json";
		Object.freeze({
			"gpt-6-astra": 872e3,
			"gpt-6-sol": 872e3,
			"gpt-6-luna": 872e3,
								...
								children: [
									...
									/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("label", {
										...
										children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("input", {
											...
											onChange: (event) => {
												update("enableNewSessionFastMode", event.currentTarget.checked);
											}
										}), /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
											style: toggleCopyStyle,
											children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
												style: labelStyle,
												children: t("enableNewSessionFastMode")
											}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
												style: bodyStyle$2,
												children: t("enableNewSessionFastModeHelp")
											})]
										})]
									}),
									/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("label", {
										...
										children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("input", {
											...
											onChange: (event) => {
												update("enableNewSubagentFastMode", event.currentTarget.checked);
											}
										}), /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
											style: toggleCopyStyle,
											children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
												style: labelStyle,
												children: t("enableNewSubagentFastMode")
											}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
												style: bodyStyle$2,
												children: t("enableNewSubagentFastModeHelp")
											})]
										})]
									}),
									/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
		...
		function OpenAICodexSettings({ t, configScope, updater, account, embedded = false, accountOnly = false }) {
			...
			const moduleSummary = (module) => {
				...
				return t("capabilitiesModuleEnabled", { count: config === void 0 ? 0 : [
					...
					config.enableNewSessionFastMode,
					config.enableNewSubagentFastMode,
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("section", {
				...
				children: [embedded ? null : /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("h2", {
					...
					style: embedded ? embeddedCardStyle : cardStyle,
					children: [
		...
		function OpenAICodexPluginCard({ t, configScope, updater, account }) {
			return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(OpenAICodexSettings, {
				t,
				configScope,
		...
		*/
		...
		const en = {
			...
			enableImageGenerationHelp: "Generate or edit conversation images with GPT Image. When enabled, Codex requests include stable handles for conversation images so the model can select them; editing sends only the selected target and reference images to the image service.",
			...
			enableNewSessionFastMode: "Fast Mode for new conversations",
			enableNewSessionFastModeHelp: "Off by default. New top-level conversations using Codex request priority service; existing conversations and their manual choices stay unchanged. Priority may use quota faster.",
			enableNewSubagentFastMode: "Fast Mode for new subagent conversations",
			enableNewSubagentFastModeHelp: "A separate opt-in default for new subagent conversations using Codex. Off by default; it does not inherit the top-level setting.",
			...
			imageEditing: "Editing image…",
			editInstructions: "What should change?",
			editTarget: "Image to modify",
			selectEditTarget: "Select one image",
			submitImageEdit: "Send edit request",
			cancelImageEdit: "Cancel edit",
			choosePreviewEdit: "Use this conversation preview (the original is unavailable)",
			previewEditNotice: "Only the saved preview is available. Editing it may reduce image quality.",
			retryImageEdit: "Repeat this edit",
			editFrom: "Edited from {source}; {count} reference image(s).",
			imageRequestUncertain: "The service may still be processing this request. Repeating it can consume additional quota.",
			imageUnknownFailure: "The image request failed. Private service details are hidden; check the selected images and account before trying again.",
			imageInputRecovery: "Correct the selection or instructions in the conversation before retrying. Specify whether to edit the uploaded copy or the stored original; repeating these inputs will not resolve this error.",
			imageStorageRecovery: "Check local storage and available space before trying again. The service may already have processed this request.",
		...
		const zh = {
			...
			enableImageGenerationHelp: "在对话中生成或编辑图片。启用后，Codex 请求会为对话图片附加稳定句柄，帮助模型准确选图；编辑时，仅将本次选定的主图和参考图发送给图片服务。",
			...
			enableNewSessionFastMode: "新对话默认使用 Fast Mode",
			enableNewSessionFastModeHelp: "默认关闭。开启后，新建的主对话在使用 Codex 时请求优先服务；不改变已有对话或手动选择，可能更快消耗额度。",
			enableNewSubagentFastMode: "新子代理对话默认使用 Fast Mode",
			enableNewSubagentFastModeHelp: "独立于主对话的可选默认值，默认关闭；新子代理对话在使用 Codex 时请求优先服务，不自动继承主对话设置。",
			...
			imageEdited: "图片已编辑",
			imageEditing: "正在编辑图片…",
			editInstructions: "需要修改什么？",
			editTarget: "要修改的图片",
			selectEditTarget: "请选择一张图片",
			submitImageEdit: "发送修改请求",
			cancelImageEdit: "取消修改",
			choosePreviewEdit: "使用此对话预览图（原图不可用）",
			previewEditNotice: "只有已保存的预览图可用，使用它编辑可能降低画质。",
			retryImageEdit: "重做本次修改",
			editFrom: "修改自 {source}；使用了 {count} 张参考图。",
			imageRequestUncertain: "服务可能仍在处理这次请求，重复提交可能额外消耗额度。",
			imageUnknownFailure: "图片请求失败。已隐藏服务端私有细节；请先检查所选图片和账户状态，再决定是否重试。",
			imageInputRecovery: "请先在对话中修正选图或修改要求，并明确使用本次上传的图片还是历史原图。原样重复这次请求无法解决该错误。",
			imageStorageRecovery: "请先检查本地存储和剩余空间，再决定是否重试。服务端可能已经处理了这次请求。",
		...
		({ ...IMAGE_INPUT_SCHEMA }), { ...IMAGE_REFERENCES_SCHEMA };
		//#endregion
		...
		//#endregion
		//#region src/client/image-result-presentation.ts
		...
		function promptForImageToolBlock(block) {
			if (!("kind" in block)) return block.phase === "start" ? promptFromArgs(block.argsRaw) : void 0;
		...
		function imageRequestForToolBlock(block) {
			const raw = !("kind" in block) ? block.phase === "start" ? block.argsRaw : void 0 : block.call?.argsRaw;
			if (raw !== void 0) try {
				return decodeImageToolRequest(JSON.parse(raw));
			} catch {
				return;
			}
		...
		function imagePresentationForResult(block) {
			if (block.isError || block.call !== null && block.call.name !== IMAGE_TOOL) return void 0;
		...
		function safeImageFailure(content) {
		...
		*/
		...
		function imageActionsEnabled(scope) {
			return scope === void 0 || scope.getSnapshot().value?.enableImageGeneration === true;
		}
		function useImageActionsEnabled(scope) {
		...
		function useSessionActions(sessionId, sessions, configScope) {
		...
		function errorState(block, t) {
			...
			return {
				title: t("failed"),
				detail: reauth ? t("reauthRequired") : safe?.message ?? t("imageUnknownFailure"),
				retryable: !reauth && (safe?.retryable ?? true),
				recovery: safe?.recovery
			};
		}
		function CodexImageToolView({ block, sessionId, t, sessions, configScope }) {
			...
			const decoded = (0, react.useMemo)(() => "kind" in block ? imagePresentationForResult(block) : void 0, [block]);
			if (!("kind" in block)) return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(ResponsiveCard, {
				...
				visual: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
					...
					children: [
						/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
							style: header,
							children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)("strong", { children: t(request?.operation === "edit" ? "imageEditing" : "generating") })
						}),
						/* @__PURE__ */ (0, react_jsx_runtime.jsx)("progress", {
							style: progress,
							"aria-label": t(request?.operation === "edit" ? "imageEditing" : "generating")
						}),
						/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
							style: detail,
				...
				return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(ResponsiveCard, {
					...
					visual: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [
							...
							contentText(block.content)?.includes("may still be processing") === true ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
								style: detail,
								children: t("imageRequestUncertain")
							}) : null,
							state.recovery === "input" ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
								style: detail,
								children: t("imageInputRecovery")
							}) : null,
							state.recovery === "storage" ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
								style: detail,
								children: t("imageStorageRecovery")
							}) : null,
							request === void 0 || !actionsEnabled || !state.retryable ? null : /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								style: actionRow,
								children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
									type: "button",
									style: action,
									...
									onClick: () => {
										sessionActions.followUp(imageRequestFollowUp(request));
									},
									children: sessionActions.pending === "follow-up" ? t("actionSending") : t(request.operation === "edit" ? "retryImageEdit" : "retryGeneration")
								}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)(ActionError, {
									visible: sessionActions.failed,
									t
								})]
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(ImageResultCard, {
				decoded,
				sessionId,
				load,
				sessionActions,
		...
		function CodexImageTurnResult({ block, sessionId, sessions, t, configScope }) {
			const load = useImageLoader(sessionId, sessions);
			const actionsEnabled = useImageActionsEnabled(configScope);
			const sessionActions = useSessionActions(sessionId, sessions, configScope);
			const galleryLabels = (0, react.useMemo)(() => labels(t), [t]);
			const decoded = (0, react.useMemo)(() => imagePresentationForResult(block), [block]);
		...
		function imageInputLabel(input) {
		...
		function ImageEditForm({ decoded, actions, onClose, t }) {
			const [selected, setSelected] = (0, react.useState)(decoded.images.length === 1 ? "0" : "");
			const [instructions, setInstructions] = (0, react.useState)("");
			const [allowPreview, setAllowPreview] = (0, react.useState)(false);
			...
			const image = selected === "" ? void 0 : decoded.images[Number(selected)];
			const previewOnly = image !== void 0 && image.original === void 0;
			const ready = image !== void 0 && instructions.trim().length > 0 && (!previewOnly || allowPreview);
			async function send() {
				if (!ready || image === void 0 || actions.pending !== null) return;
				const target = image.original === void 0 ? {
					attachmentId: String(image.preview.attachmentId),
					usePreview: true
				} : { assetId: image.original.assetId };
				if (await actions.followUp(imageRequestFollowUp({
					operation: "edit",
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("form", {
				...
				children: [
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("label", {
						style: detail,
						children: [t("editTarget"), /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("select", {
							...
							children: [decoded.images.length > 1 ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("option", {
								value: "",
								children: t("selectEditTarget")
							}) : null, decoded.images.map((item, index) => /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("option", {
								value: String(index),
								children: [
									String(index + 1),
									". ",
									item.original?.name ?? item.preview.name ?? t("image")
								]
							}, `${item.original?.assetId ?? item.preview.attachmentId}:${index}`))]
						})]
					}),
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("label", {
						style: detail,
						children: [t("editInstructions"), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("textarea", {
					...
					previewOnly ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
						role: "status",
						style: detail,
						children: t("previewEditNotice")
					}), /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("label", {
						style: detail,
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("input", {
							type: "checkbox",
							...
							disabled: actions.pending !== null,
							onChange: (event) => {
								setAllowPreview(event.currentTarget.checked);
							}
						}), t("choosePreviewEdit")]
					})] }) : null,
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
							type: "submit",
							style: action,
							disabled: !ready || actions.pending !== null,
							children: actions.pending === null ? t("submitImageEdit") : t("actionSending")
						}), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
							type: "button",
							style: action,
							disabled: actions.pending !== null,
							onClick: onClose,
							children: t("cancelImageEdit")
						})]
					})
				]
			});
		...
		function ImageResultCard({ decoded, sessionId, load, sessionActions, galleryLabels, actionsEnabled, t }) {
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(ResponsiveCard, {
				label: t(decoded.edit === void 0 ? "completed" : "imageEdited"),
				visual: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
					style: header,
					children: /* @__PURE__ */ (0, react_jsx_runtime.jsx)("strong", { children: t(decoded.edit === void 0 ? "completed" : "imageEdited") })
				...
				side: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
						...
						children: [
							/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
								type: "button",
								style: action,
								disabled: !actionsEnabled || sessionActions.pending !== null,
								"aria-busy": sessionActions.pending === "follow-up",
								onClick: () => {
									sessionActions.followUp(imageRequestFollowUp(decoded.edit === void 0 ? {
										operation: "generate",
										prompt: decoded.prompt
									} : {
										operation: "edit",
								...
								children: sessionActions.pending === "follow-up" ? t("actionSending") : t(decoded.edit === void 0 ? "regenerate" : "retryImageEdit")
							}),
							/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
								type: "button",
								style: action,
					...
					decoded.edit === void 0 ? null : /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
						style: detail,
						children: t("editFrom", {
							source: imageInputLabel(decoded.edit.target),
							count: decoded.edit.references.length
						})
					}),
					editing && actionsEnabled ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)(ImageEditForm, {
						decoded,
						...
						t
					}, JSON.stringify([sessionId, decoded.images.map((image) => [image.original?.assetId ?? null, image.preview.attachmentId])])) : null,
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
						style: {
							display: "flex",
							flexWrap: "wrap",
						...
						children: decoded.images.flatMap((image, index) => {
							...
							}, `${exactOriginal.assetId}:${index}:original`)], /* @__PURE__ */ (0, react_jsx_runtime.jsx)(DownloadButton, {
								onDownload: async () => {
							...
							}, `${image.preview.attachmentId}:${index}:preview`)];
						})
					}),
					/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("details", { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("summary", {
						style: {
						...
						children: decoded.images.flatMap((image, index) => {
							...
							}) }, `${original.assetId}:${index}:original`), /* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", { children: t("previewImageDetail", {
								format: formatMediaType(preview.mediaType),
								width: preview.width,
								height: preview.height,
								size: formatBytes(preview.bytes)
							}) }, `${preview.attachmentId}:${index}:preview`)];
						})
					})] })
				] })
			});
		...
		//#endregion
		//#region src/client/CodexImageTurnTail.tsx
		...
		function selectTurnImageResults(rows, closingSeq) {
			const images = [];
			for (const row of rows) {
				...
				while (pending.length > 0) {
					...
					if (block === void 0 || visited.has(block.callId)) continue;
					visited.add(block.callId);
					if ("kind" in block && block.seq <= closingSeq && imagePresentationForResult(block) !== void 0) images.push(block);
		...
		function CodexImageTurnTail({ turn, seq, sessionId, useChat, sessions, configScope, t }) {
			...
			const results = (0, react.useMemo)(() => selectTurnImageResults(rows, seq), [rows, seq]);
			if (results.length === 0) return null;
			return /* @__PURE__ */ (0, react_jsx_runtime.jsx)("section", {
				"data-turn-image-results": "",
				"aria-label": t("completed"),
				style: resultStack,
				children: results.map((block) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)(CodexImageTurnResult, {
					block,
					sessionId,
					sessions,
					configScope,
		...
		function decodeTaskState(value) {
			...
			if (value.delegation !== void 0) {
				const d = value.delegation;
				if (!taskRecord(d) || d.version !== 1 && d.version !== 2 || typeof d.idle !== "boolean" || typeof d.enabled !== "boolean" || typeof d.canDowngrade !== "boolean" || !Array.isArray(d.files) || d.files.length > 32 || d.files.some((file) => typeof file !== "string" || file.length > 512) || !Array.isArray(d.routes) || d.routes.length > 64 || d.routes.some((route) => !taskRoute(route)) || !Number.isSafeInteger(d.maxRequests) || Number(d.maxRequests) < 1 || Number(d.maxRequests) > 6 || !Number.isSafeInteger(d.timeoutMs) || Number(d.timeoutMs) < 1e3 || Number(d.timeoutMs) > 9e4 || !Array.isArray(d.runs) || d.runs.length > 32 || d.runs.some((run) => !taskRecord(run) || typeof run.id !== "string" || !/^[A-Za-z0-9_-]{16,80}$/u.test(run.id) || ![
					"prepared",
					"running",
					"settling",
					"succeeded",
					...
					"failed",
					"verified"
				].includes(String(run.cleanup)) || ![
					"none",
					"pending",
					"recorded",
					"unknown"
				].includes(String(run.delivery)) || !Number.isSafeInteger(run.reserved) || Number(run.reserved) < 0 || Number(run.reserved) > 6)) return void 0;
			}
			return value;
		}
		//#endregion
		//#region src/client/PublishedAdaptiveTaskControl.tsx
		/** Published entry: no activation UI while paused; existing tasks retain safety exits. */
		const words = {
			en: {
				button: "Existing task controls",
				title: "Existing task recovery",
		...
		function PublishedAdaptiveTaskControl(props) {
			return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(TaskRecoveryControl, { ...props }, props.sessionId);
		}
		function TaskRecoveryControl({ sessionId, language = "en" }) {
			...
			const working = (0, react.useRef)(false);
			const controller = (0, react.useRef)();
			const dialog = (0, react.useRef)(null);
			const opener = (0, react.useRef)(null);
			const request = (0, react.useCallback)(async (action, revision) => {
				if (working.current || action !== void 0 && revision === void 0) return;
				...
				try {
					let decoded;
					for (let attempt = 0; attempt < (action === void 0 ? 3 : 1); attempt++) {
						const response = await fetch(action === void 0 ? `${ADAPTIVE_TASK_PATH}?sessionId=${encodeURIComponent(sessionId)}` : ADAPTIVE_TASK_PATH, {
							method: action === void 0 ? "GET" : "POST",
							credentials: "same-origin",
							signal: operation.signal,
							headers: {
								accept: "application/json",
								...action === void 0 ? {} : { "content-type": "application/json" }
							},
							...action === void 0 ? {} : { body: JSON.stringify({
								sessionId,
								action,
								revision,
						...
						if (action === void 0 && response.status === 409 && typeof body === "object" && body !== null && "error" in body && body.error === "TASK_LIVE_ROOT_REQUIRED" && attempt < 2) {
					...
					if (decoded === void 0) throw new Error("Unconfirmed task state");
			...
			if (state?.mode === "off" || state === void 0 && !failed && !opened) return null;
			return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("button", {
				ref: opener,
				type: "button",
				style: buttonStyle,
				...
				children: [
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", { children: text.paused }),
					...
					state !== void 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("p", { children: [
						text.mode,
						": ",
						state.mode,
		...
		*/
		...
		function apply(ctx) {
			...
			}), "dsh-codex-connect: settings page while served");
