	...
	factory: (require) => {
		...
		*/
		...
		const en = {
			...
			fastModeEnabledTitle: "Fast Mode is on for this conversation. Click to turn it off. Priority may consume quota faster.",
			fastModeDisabledTitle: "Fast Mode is off for this conversation. Click to turn it on. Priority may consume quota faster.",
		...
		const zh = {
			...
			fastModeEnabledTitle: "此对话已开启 Fast Mode。点击关闭。Priority 可能更快消耗额度。",
			fastModeDisabledTitle: "此对话未开启 Fast Mode。点击开启。Priority 可能更快消耗额度。",
