	...
	factory: (require) => {
		...
		function parseOpenAICodexUpdateResult(value) {
			...
			const highlights = rawHighlights === void 0 ? [] : Array.isArray(rawHighlights) ? rawHighlights.flatMap((value) => {
				...
				if (kind !== "trusted-origins" && kind !== "quota-fast-mode" && kind !== "dsh-rc7" && kind !== "search-stability" && kind !== "image-generation" && kind !== "oauth-history") return [];
				return [{
					version,
					kind
				}];
				...
				children: [
					...
					snapshot.status === "idle" || snapshot.status === "checking" ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
						...
						technicalDetails ? snapshot.releaseNotes === void 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
							...
							style: notesStyle,
							children: snapshot.releaseNotes
						}) : null,
						/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
							style: actionStyle,
							children: [
		...
		*/
		...
		const en = {
			...
			upgradeCommandHelp: "Copy the command, run it in the terminal, then return here and check again. The plugin will not run it automatically:",
			upgradeStepsHeading: "Finish the upgrade",
			upgradeStepCopy: "1. Copy the command.",
			upgradeStepRun: "2. Run it in the terminal.",
			upgradeStepRestart: "3. Restart this profile’s DSH Web process if needed.",
		...
		const zh = {
			...
			upgradeCommandHelp: "复制命令并在终端执行，然后回到这里重新检查。插件不会自动执行：",
			upgradeStepsHeading: "完成升级",
			upgradeStepCopy: "1. 复制命令。",
			upgradeStepRun: "2. 在终端执行命令。",
			upgradeStepRestart: "3. 如果没有自动生效，请重启当前 profile 的 DSH Web。",
