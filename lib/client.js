	...
	factory: (require) => {
		...
		*/
		...
		const en = {
			...
			enableImageGenerationHelp: "Generate or edit conversation images with GPT Image. Editing sends only the selected target and reference images to the image service.",
		...
		const zh = {
			...
			enableImageGenerationHelp: "在对话中生成或编辑图片。编辑时，仅将本次选定的主图和参考图发送给图片服务。",
