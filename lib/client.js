	...
	factory: (require) => {
		...
		*/
		...
		function targetSignal(target) {
			...
			return status !== void 0 && status >= 200 && status < 300 ? "green" : "yellow";
		}
		...
		function pointFromRatio(ratio, bounds) {
			...
			const height = Math.max(0, bounds.height - BALL_SIZE - 32);
			return clampPoint({
		...
		function ratioFromPoint(point, bounds) {
			...
			const height = Math.max(1, bounds.height - BALL_SIZE - 32);
			return {
		...
		function OpenAICodexProxyIndicator({ directory, configScope, sessionKey, t }) {
			...
			const openDown = bounds === void 0 || position.y + BALL_SIZE + panelHeight <= bounds.bottom - EDGE_GAP;
			const openPanel = () => {
				if (closeTimer.current !== void 0) clearTimeout(closeTimer.current);
      ...
      ` }),
								...
								children: [report?.targets.map((target) => {
									...
									return /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
										...
										children: [/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
											...
											children: target.reachable ? t("connectivityReachable", {
		...
		const en = {
			...
			connectivitySignalGreen: "All Codex endpoints are healthy",
			connectivitySignalYellow: "Codex endpoints responded with a non-success status",
			...
			connectivityReachable: "HTTP {status} · {latency} ms",
		...
		const zh = {
			...
			connectivitySignalYellow: "Codex 相关站点已响应，但状态异常",
			...
			return /* @__PURE__ */ (0, react_jsx_runtime.jsx)(ResponsiveCard, {
				...
				side: /* @__PURE__ */ (0, react_jsx_runtime.jsxs)(react_jsx_runtime.Fragment, { children: [
					...
					/* @__PURE__ */ (0, react_jsx_runtime.jsx)("div", {
						...
						children: decoded.images.map((image, index) => /* @__PURE__ */ (0, react_jsx_runtime.jsx)(DownloadButton, {
							image,
							load,
							t,
							label: decoded.images.length === 1 ? t("download") : t("downloadNamed", { name: image.name ?? String(index + 1) })
						}, image.attachmentId))
					}),
