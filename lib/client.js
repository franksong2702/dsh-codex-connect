	...
	factory: (require) => {
		...
		*/
		...
		function OpenAICodexConfiguration({ scope, t }) {
			...
			const testedManualProxy = draft !== void 0 && manualProbe?.reachable === true && manualProbe.proxyUrl === normalizeOpenAICodexProxyUrl(draft.proxyUrl);
						...
						children: [
							...
							manualProxy ? /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("div", {
								...
								children: [
									...
									!draft.enableProxy && !testedManualProxy ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
										style: bodyStyle$2,
