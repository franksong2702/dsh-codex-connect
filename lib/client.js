window.__ModuleLoader__.load({
	...
	factory: (require) => {
		...
		function compatibilityIssueUrl(currentVersion, latestPluginVersion, latestDshVersion) {
		...
		function UpdateContents({ updater, t, overlay }) {
			...
			const noticeKey = latestVersion === void 0 ? void 0 : `${latestVersion}:${compatibility?.latestDshVersion ?? "unknown"}:${compatibility?.status ?? "none"}`;
						...
						children: [
							/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("strong", {
								...
								children: [
									...
									" ",
									t(compatibilityTitleKeys[compatibility.status])
								]
							}),
							compatibility.latestDshVersion === void 0 ? null : /* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
								style: bodyStyle$1,
								children: t("compatibilityLatestDsh", { version: compatibility.latestDshVersion })
							}),
							/* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
								style: bodyStyle$1,
								children: t("compatibilityCurrentPlugin", { version: snapshot.currentVersion })
							}),
							/* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
								style: bodyStyle$1,
								children: t("compatibilityLatestPlugin", { version: compatibility.latestPluginVersion })
							}),
							/* @__PURE__ */ (0, react_jsx_runtime.jsx)("p", {
								style: bodyStyle$1,
								children: t(compatibilityBodyKeys[compatibility.status])
							}),
							compatibility.status === "not-yet-compatible" && compatibility.latestDshVersion !== void 0 ? /* @__PURE__ */ (0, react_jsx_runtime.jsx)("a", {
								href: compatibilityIssueUrl(snapshot.currentVersion, compatibility.latestPluginVersion, compatibility.latestDshVersion),
								target: "_blank",
								rel: "noopener noreferrer",
		...
		*/
		...
		const en = {
			...
			compatibilityLatestDsh: "Latest DSH version: {version}",
			compatibilityCurrentPlugin: "Installed Codex Connect: {version}",
			compatibilityLatestPlugin: "Latest Codex Connect: {version}",
		...
		const zh = {
			...
			compatibilityLatestDsh: "最新 DSH 版本：{version}",
			compatibilityCurrentPlugin: "当前 Codex Connect：{version}",
			compatibilityLatestPlugin: "最新 Codex Connect：{version}",
