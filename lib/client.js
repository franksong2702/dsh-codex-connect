	...
	factory: (require) => {
						...
						children: [
							...
							/* @__PURE__ */ (0, react_jsx_runtime.jsxs)("label", {
								...
								children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("input", {
									...
									onChange: (event) => {
										update("enableAutoReview", event.currentTarget.checked);
									}
								}), /* @__PURE__ */ (0, react_jsx_runtime.jsxs)("span", {
									style: toggleCopyStyle,
									children: [/* @__PURE__ */ (0, react_jsx_runtime.jsx)("span", {
		...
		*/
		...
		const en = {
			...
			enableAutoReview: "Enable Codex Auto-review",
			enableAutoReviewHelp: "Review eligible DSH approval requests after DSH policy runs. When enabled, recent approval context, tool arguments, working directory, and the planned action are sent to chatgpt.com. Failures return to human approval.",
		...
		const zh = {
			...
			enableAutoReview: "启用 Codex 自动审查",
			enableAutoReviewHelp: "在 DSH 策略检查后审查符合条件的审批请求。启用后，最近的审批上下文、工具参数、工作目录和待执行动作会发送到 chatgpt.com；审查失败时回到人工审批。",
			generating: "正在生成图片",
		...
		*/
		...
		const CODEX_CONNECT_VERSION = "0.1.0-alpha.4.23";
		//#endregion
