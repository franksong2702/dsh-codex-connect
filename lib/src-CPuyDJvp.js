...
const CURATED_HIGHLIGHTS = [
	...
	{
		version: "0.1.0-alpha.4.9",
		kind: "quota-fast-mode"
	},
	{
	...
	{
		version: "0.1.0-alpha.4.11",
		kind: "search-stability"
	},
	{
...
function releaseHighlightsBetween(currentVersion, latestVersion) {
	return CURATED_HIGHLIGHTS.filter((highlight) => compareOpenAICodexVersions(highlight.version, currentVersion) > 0).filter((highlight) => compareOpenAICodexVersions(highlight.version, latestVersion) <= 0).map((highlight) => ({ ...highlight }));
}
