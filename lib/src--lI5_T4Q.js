...
const CODEX_CONNECT_VERSION = "0.1.0-alpha.4.32";
//#endregion
...
//#endregion
export { OPENAI_CODEX_PROXY_TEST_PATH as $, IMAGE_GENERATE_TOOL_NAME as A, openAICodexModelCatalog as At, COMPATIBILITY_CONTRACT as B, OpenAICodexCredentialStore as Bt, OPENAI_CODEX_TRANSPORT_API_VERSION as C, OPENAI_CODEX_FAST_MODE_MAX_SESSION_ID_LENGTH as Ct, OpenAICodexTransportError as D, OPENAI_CODEX_USAGE_URL as Dt, OpenAICodexTransport as E, normalizeTrustedOrigin as Et, OPENAI_CODEX_UPDATE_PATH as F, OPENAI_CODEX_ACCOUNT_LIMIT as Ft, SUPPORTED_DSH_PLUGIN_API_VERSION as G, COMPATIBILITY_SCHEMA_VERSION as H, checkForOpenAICodexUpdate as I, OPENAI_CODEX_AUTH_DOCUMENT_LIMIT as It, assessCompatibility as J, SUPPORTED_NODE_RANGE as K, compareOpenAICodexVersions as L, OPENAI_CODEX_AUTH_FILENAME as Lt, diagnoseOpenAICodex as M, logoutOpenAICodex as Mt, openAICodexConflictMessage as N, openAICodexAuthStatus as Nt, isOpenAICodexTransportError as O, parseOpenAICodexUsage as Ot, CODEX_CONNECT_VERSION as P, publicAuthError as Pt, OPENAI_CODEX_PROXY_DETECT_PATH as Q, parseOpenAICodexUpdateResult as R, OPENAI_CODEX_AUTH_V1_BACKUP_SUFFIX as Rt, OPENAI_CODEX_IMAGE_REQUEST_TIMEOUT_MS as S, OPENAI_CODEX_FAST_MODE_MAX_SESSIONS as St, OPENAI_CODEX_TRANSPORT_SERVICE as T, OpenAICodexTrustedOriginsStore as Tt, DSH_PLUGIN_API_PACKAGES as U, COMPATIBILITY_PACKAGES as V, openAICodexAuthPath as Vt, PI_AI_PACKAGE as W, evaluateCompatibility as X, detectCompatibility as Y, readInstalledPackageVersion as Z, OPENAI_CODEX_IMAGE_GENERATION_URL as _, normalizeOpenAICodexProxyUrl as _t, name as a, detectOpenAICodexProxies as at, OPENAI_CODEX_IMAGE_MAX_RESPONSE_BYTES as b, OPENAI_CODEX_FAST_MODE_PATH as bt, migrateOpenAICodexSearchHistory as c, DEFAULT_OPENAI_CODEX_SEARCH_CONTEXT_SIZE as ct, probeCodexAutoReview as d, DEFAULT_OPENAI_CODEX_SEARCH_MODEL as dt, OPENAI_CODEX_LOCAL_PROXY_CANDIDATES as et, OPENAI_CODEX_BASE_URL as f, DEFAULT_OPENAI_CODEX_SETTINGS as ft, mapOpenAICodexSearchResponse as g, isValidOpenAICodexProxyUrl as gt, OpenAICodexSearchProvider as h, isValidOpenAICodexContextWindowOverrides as ht, inject as i, OpenAICodexProxyManager as it, assertNoOpenAICodexProviderConflict as j, loginOpenAICodex as jt, VIEW_IMAGE_TOOL_NAME as k, readOpenAICodexRateLimits as kt, ASTRA_REASONING_TOOL_NAME as l, DEFAULT_OPENAI_CODEX_SEARCH_MAX_OUTPUT_TOKENS as lt, OPENAI_CODEX_SEARCH_URL as m, decodeOpenAICodexSettings as mt, OPENAI_CODEX_SETTINGS_NS as n, OPENAI_CODEX_PROXY_PROBE_TIMEOUT_MS as nt, OPENAI_CODEX_HISTORY_BACKUP_SUFFIX as o, listOpenAICodexProxyCandidates as ot, OPENAI_CODEX_SEARCH_PROVIDER as p, OPENAI_CODEX_SETTINGS_NAMESPACE as pt, SUPPORTED_PI_AI_RANGE as q, apply as r, OPENAI_CODEX_PROXY_PROBE_URL as rt, OPENAI_CODEX_SEARCH_MODEL_REQUEST_EVENT as s, DEFAULT_OPENAI_CODEX_PROXY_URL as st, Config as t, OPENAI_CODEX_PROXY_CANDIDATE_LIMIT as tt, CODEX_AUTO_REVIEW_MODEL as u, DEFAULT_OPENAI_CODEX_SEARCH_MODE as ut, OPENAI_CODEX_IMAGE_MAX_COUNT as v, resolveOpenAICodexProxyUrl as vt, OPENAI_CODEX_TRANSPORT_ERROR_CODES as w, isFastModeSessionId as wt, OPENAI_CODEX_IMAGE_PROMPT_MAX_LENGTH as x, FastModeRegistry as xt, OPENAI_CODEX_IMAGE_MAX_ERROR_BYTES as y, resolveOpenAICodexSettings as yt, parseOpenAICodexVersion as z, OPENAI_CODEX_PROVIDER as zt };
