...
//#endregion
//#region src/reasoning-update-tool.d.ts
/** Model-facing tool; every actual change requires a fresh human answer. */
declare const ASTRA_REASONING_TOOL_NAME = "codex_connect_set_reasoning_effort";
//#endregion
...
declare const SUPPORTED_DSH_PLUGIN_API_VERSIONS: readonly ["0.1.2-rc.1", "0.1.5-alpha.1"];
...
declare const COMPATIBILITY_CONTRACT: {
  ...
  readonly dshPluginApi: {
    ...
    readonly versions: readonly ["0.1.2-rc.1", "0.1.5-alpha.1"];
...
interface OpenAICodexSettingsConfig {
  ...
  /** Offer a tool that asks the user before changing this Astra conversation's effort. */
