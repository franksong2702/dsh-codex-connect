 ...
 * @deprecated The provider now records searches through standard Tool events.
 */
declare function recordOpenAICodexSearchRequest(_ctx: Context, _request: OpenAICodexSearchRequestRecord): void;
/**
