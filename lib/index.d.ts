...
declare const SUPPORTED_DSH_PLUGIN_API_VERSIONS: readonly ["0.1.2-rc.1", "0.1.5-alpha.1", "0.1.5-rc.1"];
...
declare const COMPATIBILITY_CONTRACT: {
  ...
  readonly dshPluginApi: {
    ...
    readonly versions: readonly ["0.1.2-rc.1", "0.1.5-alpha.1", "0.1.5-rc.1"];
