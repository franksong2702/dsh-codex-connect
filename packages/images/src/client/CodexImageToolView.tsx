...
export type CodexImageToolViewProps = PropsRuntime<'tool.call.toolview'> & CodexImageToolViewInjected & { t: Translate<ImagesLocaleKey> }
...
function labels(t: Translate<ImagesLocaleKey>): MessageImageLabels {
  return {
    image: t('image'),
    open: t('open'),
...
function errorState(block: Extract<CodexImageToolViewProps['block'], { kind: 'tool-result' }>, t: Translate<ImagesLocaleKey>) {
  ...
  return { title: t('failed'), detail: reauth ? t('reauth') : undefined }
}
