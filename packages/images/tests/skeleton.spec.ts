...
describe('Codex Connect Images package contract', () => {
  ...
  it('keeps network transport in core and browser/gallery work out of this package', async () => {
    ...
    expect(source).toContain('toolCtx.tools.register')
    expect(source).not.toMatch(/ImageGallery|ImageLightbox/u)
  })
